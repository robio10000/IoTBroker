...
public interface ISensorService
{
    ...
    Task<IEnumerable<SensorPayload>> GetAll(string? clientId);
    ...
    Task<SensorPayload?> GetById(string clientId, string id);
    ...
    public Task<IEnumerable<SensorPayload>> GetHistoryById(string clientId, string id);
    ...
    Task<bool> Exists(string clientId, string id);
    ...
    Task<bool> Delete(string clientId, string id);
    ...
    Task<ServiceResult> ProcessPayload(string clientId, SensorPayload payload, bool isGeneratedByRule = false);
}